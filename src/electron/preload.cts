...
electron.contextBridge.exposeInMainWorld('electron', {
  ...
  updateBucketCategory: (id: number, params: UpdateBucketCategoryParams) =>
    ipcInvoke('db:updateBucketCategory', { id, params }),
  deleteBucketCategory: (id: number) =>
    ipcInvoke('db:deleteBucketCategory', id),
  getAccounts: () => ipcInvoke('db:getAccounts'),
  createAccount: (params: CreateAccountParams) =>
    ipcInvoke('db:createAccount', params),
  updateAccount: (id: number, params: UpdateAccountParams) =>
    ipcInvoke('db:updateAccount', { id, params }),
  deleteAccount: (id: number) => ipcInvoke('db:deleteAccount', id),
  ...
  getTransactionsByBucket: (params: GetTransactionsByBucketParams) =>
    ipcInvoke('db:getTransactionsByBucket', params),
  ...
  ) => ipcInvoke('db:getExpenseTransactionsByCategoryAndPeriod', params),
  ...
  getExpensePieChartData: (params: GetExpensePieChartDataParams) =>
    ipcInvoke('db:getExpensePieChartData', params),
